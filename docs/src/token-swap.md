...
Check out the
[program repository](https://github.com/lumos-labs/lumos-program-library/tree/master/token-swap)
...
[JavaScript
bindings](https://github.com/lumos-labs/lumos-program-library/blob/master/token-swap/js/src/index.ts)
are available that support loading the Token Swap Program on to a chain and
issuing instructions.

Example user interface is available [here](https://github.com/lumos-labs/oyster-swap).
...
[end-to-end tests](https://github.com/lumos-labs/lumos-program-library/blob/master/token-swap/js/cli/token-swap-test.ts).

### Creating a new token swap pool

The creation of a pool showcases the account, instruction, and authorization
models on Lumos, which can be very different compared to other blockchains.
...
[program derived address](https://docs.lumos.com/developing/programming-model/calling-between-programs#program-derived-addresses)
...
Since Lumos programs require all accounts to be declared in the instruction,
...
that implements the
[CurveCalculator](https://github.com/lumos-labs/lumos-program-library/blob/master/token-swap/program/src/curve/calculator.rs)
...
curve](https://github.com/lumos-labs/lumos-program-library/blob/master/token-swap/program/src/curve/constant_product.rs)
...
The [constant price curve](https://github.com/lumos-labs/lumos-program-library/blob/master/token-swap/program/src/curve/constant_price.rs)
...
The [stable curve](https://github.com/lumos-labs/lumos-program-library/blob/master/token-swap/program/src/curve/stable.rs)
...
The [offset curve](https://github.com/lumos-labs/lumos-program-library/blob/master/token-swap/program/src/curve/offset.rs)
...
[curves](https://github.com/lumos-labs/lumos-program-library/blob/master/token-swap/program/src/curve/constant_product.rs)
and
[math](https://github.com/lumos-labs/lumos-program-library/blob/master/token-swap/program/src/curve/math.rs)
...
tests](https://github.com/lumos-labs/lumos-program-library/blob/master/token-swap/program/fuzz/src/instructions.rs)
of the repo.
