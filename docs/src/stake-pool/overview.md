...
- https://lumos.com/staking
- https://docs.lumos.com/staking/stake-programming
...
- https://docs.lumos.com/cli/delegate-stake
- https://docs.lumos.com/cli/manage-stake-accounts
...
The Lumos transaction processor has two important limitations:
