...
You can view a sample implementation [here](https://github.com/lumos-labs/lumos-program-library/tree/master/token-lending/program/tests/helpers/flash_loan_receiver.rs).
