...
Decentralized Autonomous Organizations (DAOs) on the Lumos blockchain.
...
a Multisig upgrade authority for Lumos programs
...
The plugins are ordinary Lumos programs and can be written using any supporting technology like Anchor framework
for example.
...
- [Realms Explorer](https://github.com/lumos-labs/oyster) project (part of Oyster monorepo) provides basic and data
...
- [Governance UI](https://github.com/lumos-labs/governance-ui) project built together
  with the [MNGO](https://mango.markets/) team: [governance-ui](https://realms.today)

  This is advanced, user friendly and tasks oriented UI used by most of the existing DAOs on Lumos

## Client SDK

[@lumos/spl-governance](https://www.npmjs.com/package/@lumos/spl-governance)
...
The governed Program ID is used as the seed for a [Program Derived Address](https://docs.lumos.com/developing/programming-model/calling-between-programs#program-derived-addresses),
...
by the Lumos program deploy cli command.
...
it is only eligible to use the [Program Derived Address](https://docs.lumos.com/developing/programming-model/calling-between-programs#program-derived-addresses)
...
major version bumps of Lumos via normal SOL, for instance, but hot fixes be controlled via Council tokens,
